...
$mm=mysqli_query($conn,"insert into grade values(' ','$id','$fn','$mn','$ln','$sex','$dept','$yea','$sem','$sec','$c1','$c2','$c3','$c4','$c5','$c6','$c7','$ch1','$ch2','$ch3','$ch4','$ch5','$ch6','$ch7','$g1','$g2','$g3','$g4','$g5','$g6','$g7','$tcr','$tgp','$cgpa','$pcgpa','$ptc','$ncgpa',' ')")or die(mysqli_error()); 
          if($mm){
