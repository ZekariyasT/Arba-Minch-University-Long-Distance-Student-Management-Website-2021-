...
<tr><td>
<?php
		include("sidemenudir.php");
	?>				

</td><td>
	<div id="contentindex500">
<div style="height:500px; width:600px;margin-top: -50px; ">
<section id="contact">
 <h3 class="slanted">Contact Me</h3>
      
	 <h4 style="text-align:center;margin-top: -60px;">Section&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;B</h4>
	
	  <table width="530px" height="320px" border="4" cellspacing="8" cellpadding="8"  style="text-align:left;color:black;">
						...
						<tr>
							...
							<td><img  class="bf" src="../images/y.jpg" height="30px" width="30px"></td>
							<style type="text/css"> 
							.bf{
