...
$result=mysqli_query($conn,"select * from user where UID='$user_id'")or die(mysql_error);
...
$date=date("Y-m-d");
?><br/>
<fieldset><legend align="center">New Message Submit Form</legend>
...
<tr bgcolor="" ><td align="center" colspan="4" ><font style="Time New Roman" size='3'></font></td></tr>
<tr>
<td colspan = "2">   </td>
</tr>
<tr>
...
<?php 
$result=mysqli_query($conn,"select UID from account where Role='department_head' or Role='registrar' or Role='instructor' or Role='collage_dean' or Role='cdeofficer'");
