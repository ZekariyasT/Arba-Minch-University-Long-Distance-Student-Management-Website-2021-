...
<?php
$query = mysqli_query($conn,"select * from payment_table where unread='no' and status=' ' and type='massignment' and c_code='$cc'")
or die(mysqli_error());
...
$count_item=mysqli_query($conn,"select * from payment_table where unread='yes' and type='massignment' and c_code='$cc'" ) or die(mysqli_error());
$count=mysqli_num_rows($count_item);	
echo"<font color='red'>".($count)."</font>"; ?></p>							
									<?php
$query1 = mysqli_query($conn,"select * from payment_table where unread='yes' and type='massignment' and c_code='$cc'")
or die(mysqli_error());
?>

<?php	
							
$sql = "SELECT * FROM payment_table where unread='yes' and type='massignment' and c_code='$cc'";
...
?>
<table  id="resultTable" cellspacing="0" width="100%" border="1">
<tr bgcolor="#CAE8EA">
<th>No</th>
<th>Sender<br>UID</th>
