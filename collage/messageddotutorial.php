...
$count_item=mysqli_query($conn,"select * from payment_table where unread='yes' and type='tutorial' and c_code='$cc'" ) or die(mysqli_error());
$count=mysqli_num_rows($count_item);	
echo"<font color='red'>".($count)."</font>"; ?></p>							
									<?php
$query1 = mysqli_query($conn,"select * from payment_table where unread='yes' and type='tutorial' and c_code='$cc'")
or die(mysqli_error());
?>

<?php	
							
$sql = "SELECT * FROM payment_table where unread='yes' and type='tutorial' and c_code='$cc'";
