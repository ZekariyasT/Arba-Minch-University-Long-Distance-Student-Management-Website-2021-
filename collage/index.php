        ...
        <link href="csss/startmin.css" rel="stylesheet"/>
            <center>
             <div id="page-wrapper">
            	...
            	<?php
$query = mysqli_query($conn,"select distinct status,unread,type from payment_table where status=' ' and unread='no' and c_code='$cc'")or die(mysqli_error());
while($row=mysqli_fetch_array($query))
{
$p=$row['type'];
$query1 = mysqli_query($conn,"select * from payment_table where status=' ' and unread='no' and c_code='$cc' and type='$p'")or die(mysqli_error());
$coun = mysqli_num_rows($query1);
