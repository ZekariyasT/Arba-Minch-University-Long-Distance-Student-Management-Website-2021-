...
<a href="messageddifexam.php"><i class="icon-envelope-alt"></i><font size="4px"> Seen Request</font></a>
									...
									<font size="3px">
<?php
$sql = "select * from payment_table where unread='no' and status=' ' and type='iexam' and c_code='$cc'";
$rst=mysqli_query($conn,$sql);
	...
	$rs = $pager->paginate();									
$query1 = mysqli_query($conn,"select * from payment_table where unread='no' and status=' ' and type='iexam' and c_code='$cc'")
or die(mysqli_error());
...
<td><?php echo $row["No_of_Sections"]; ?></td>
	...
	?>
	<td rowspan="<?php echo $count; ?>"><?php echo '<a  href="ifinalexam.php">Send All To CDEO</a>';?></td>
	</tr></table>
	<?php
