...
<?php 
$result=mysqli_query($conn,"select UID from account where Role='department_head' or Role='registrar' or Role='instructor' or Role='student' or Role='collage_dean' or Role='cdeofficer'");
